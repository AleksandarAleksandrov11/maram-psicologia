      ...
      <div className="container-elegant section-spacing">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <img
              src="/logo-maram-letrasblancas.webp"
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-sm text-primary-foreground/70">
              ...
              <li>Relaciones y vínculos</li>
              <li>Procesos de cambio</li>
              <li>Exigencia interna</li>
          ...
          <div>
            ...
            <ul className="space-y-4 font-sans text-sm">
              <li className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/70">+34 698 994 566</span>
              </li>
              <li className="flex items-center gap-3">
